...
real(DP),parameter :: TALLYCOVERAGE = 0.1_DP   ! The total area coverage to reach before a tally step is executed
...
real(DP),parameter :: SOFTEN_FACTOR = 0.35_DP   ! Extra per crater diffusion constant
